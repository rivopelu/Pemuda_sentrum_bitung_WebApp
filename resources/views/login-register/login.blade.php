                            ...
                            <div class="card card-plain">
                                ...
                                <div class="card-body">
                                    ...
                                    <form role="form" action="/login" method="post">
                                        @csrf
                                        <div class="mb-3">
                                            <input required type="email" class="form-control form-control-lg @error('email') is-invalid @enderror" placeholder="Email"
                                                aria-label="Email" autofocus name="email" id="email" value="{{ old('email') }}" >
